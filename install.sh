...
installV2Ray() {
	...
	if [[ "${coreInstallType}" != "2" && "${coreInstallType}" != "3" ]]; then
		...
		if wget --help | grep -q show-progress; then
			wget -c -q --show-progress -P /etc/v2ray-agent/v2ray/ "https://github.com/Reewindy/v2ray-agent/raw/main/v2ray-core/releases/download/v4.45.2/v2ray-linux-64.zip"
		else
			wget -c -P /etc/v2ray-agent/v2ray/ "https://github.com/Reewindy/v2ray-agent/raw/main/v2ray-core/releases/download/v4.45.2/v2ray-linux-64.zip" >/dev/null 2>&1
		fi

		unzip -o "/etc/v2ray-agent/v2ray/v2ray-linux-64.zip" -d /etc/v2ray-agent/v2ray >/dev/null
		chmod -R 777 /etc/v2ray-agent/v2ray
...
installXray() {
	...
	if [[ "${coreInstallType}" != "1" ]]; then
		...
		if wget --help | grep -q show-progress; then
			wget -c -q --show-progress -P /etc/v2ray-agent/xray/ "https://github.com/Reewindy/v2ray-agent/raw/main/Xray-core/releases/download/v1.6.1/Xray-linux-64.zip"
		else
			wget -c -P /etc/v2ray-agent/xray/ "https://github.com/Reewindy/v2ray-agent/raw/main/Xray-core/releases/download/v1.6.1/Xray-linux-64.zip" >/dev/null 2>&1
		fi
...
EOF
			...
			echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=vless%3A%2F%2F${id}%40${currentHost}%3A${currentDefaultPort}%3Fencryption%3Dnone%26security%3Dxtls%26type%3Dtcp%26${currentHost}%3D${currentHost}%26headerType%3Dnone%26sni%3D${currentHost}%26flow%3Dxtls-rprx-direct%23${email}\n"
...
EOF
			...
			echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=vless%3A%2F%2F${id}%40${currentHost}%3A${currentDefaultPort}%3Fencryption%3Dnone%26security%3Dxtls%26type%3Dtcp%26${currentHost}%3D${currentHost}%26headerType%3Dnone%26sni%3D${currentHost}%26flow%3Dxtls-rprx-splice%23${email/direct/splice}\n"
...
EOF
			...
			echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=vless%3a%2f%2f${id}%40${currentHost}%3a${currentDefaultPort}%3fsecurity%3dtls%26encryption%3dnone%26host%3d${currentHost}%26headerType%3dnone%26type%3dtcp%23${email}\n"
		fi
...
EOF
		...
		echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=trojan%3A%2F%2F${id}%40${currentHost}%3A${currentDefaultPort}%3Fencryption%3Dnone%26security%3Dxtls%26type%3Dtcp%26${currentHost}%3D${currentHost}%26headerType%3Dnone%26sni%3D${currentHost}%26flow%3Dxtls-rprx-direct%23${email}\n"
...
EOF
		echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=vmess://${qrCodeBase64Default}\n"
...
EOF
		...
		echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=vless%3A%2F%2F${id}%40${currentAdd}%3A${currentDefaultPort}%3Fencryption%3Dnone%26security%3Dtls%26type%3Dws%26host%3D${currentHost}%26sni%3D${currentHost}%26path%3D%252f${currentPath}ws%23${email}"
...
EOF
		...
		echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=vless%3A%2F%2F${id}%40${currentAdd}%3A${currentDefaultPort}%3Fencryption%3Dnone%26security%3Dtls%26type%3Dgrpc%26host%3D${currentHost}%26serviceName%3D${currentPath}grpc%26path%3D${currentPath}grpc%26sni%3D${currentHost}%26alpn%3Dh2%23${email}"
...
EOF
		...
		echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=trojan%3a%2f%2f${id}%40${currentHost}%3a${port}%3fpeer%3d${currentHost}%26sni%3d${currentHost}%26alpn%3Dhttp/1.1%23${email}\n"
...
EOF
		...
		echoContent green "    https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=hysteria%3A%2F%2F${currentHost}%3A${hysteriaPort}%3Fprotocol%3D${hysteriaProtocol}%26auth%3D${id}%26peer%3D${currentHost}%26insecure%3D0%26alpn%3Dh3%26upmbps%3D${hysteriaClientUploadSpeed}%26downmbps%3D${hysteriaClientDownloadSpeed}%23${email}\n"
	fi
	...
	if [[ -n "${configPath}" ]]; then
		...
		if [[ -n $(ls /etc/v2ray-agent/subscribe/) ]]; then
			find /etc/v2ray-agent/subscribe/* | while read -r email; do
				...
				echoContent yellow "在线二维码:https://apiqr.15sow.com/v1/create-qr-code/?size=400x400&data=https://${currentDomain}/s/${email}\n"
